...
namespace Memcury
{
    ...
    {
        return reinterpret_cast<HMODULE>(ImageBase67);
    }
    ...
    namespace PE
    {
        ...
        {
            return ImageBase67;
            //return Globals::moduleName == 0 ? ImageBase67 : uint64_t(GetModuleHandleA(Globals::moduleName));
        }

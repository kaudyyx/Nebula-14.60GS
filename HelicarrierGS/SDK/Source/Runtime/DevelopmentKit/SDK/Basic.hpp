...
namespace Offsets
{
	constexpr int32 GObjects          = 0x093E0A40;
	constexpr int32 AppendString      = 0x0355E530;
	constexpr int32 GNames            = 0x093C3F00;
	constexpr int32 GWorld            = 0x0951B9D0;
	constexpr int32 ProcessEvent      = 0x0376B220;
	constexpr int32 ProcessEventIdx   = 0x00000043;
    constexpr int32 Free              = 0x00000000;
    constexpr int32 Realloc           = 0x0346CD80;
}
...
public:
	...
	inline int GetSerialByIdx(const int32 Index) const
	{
		const int32 ChunkIndex = Index / ElementsPerChunk;
		const int32 InChunkIdx = Index % ElementsPerChunk;
...
public:
	...
	bool operator<(const FName& Other) const
	{
		return ComparisonIndex == Other.ComparisonIndex ? Number < Other.Number : ComparisonIndex < Other.ComparisonIndex;
	}
};

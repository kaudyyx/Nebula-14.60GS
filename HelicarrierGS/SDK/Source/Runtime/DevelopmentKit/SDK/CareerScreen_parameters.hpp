...
public:
	...
	TArray<float>                                 K2Node_MakeArray_Array;                            // 0x0008(0x0010)(ReferenceParm, HasGetValueTypeHash)
	bool                                          CallFunc_UseElectraForReplayCinematic_ReturnValue; // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UActivatableMovieWidget_Monolithic_Native_C* CallFunc_Create_ReturnValue;                  // 0x0030(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVideoConfig_Mono                      K2Node_MakeStruct_VideoConfig_Mono;                // 0x0038(0x0060)()

...
public:
	...
	static struct FConversationTaskResult AdvanceConversationWithChoice(const struct FConversationContext& Context, const struct FConversationChoiceReference& Choice);
...
public:
	...
	TArray<struct FClientConversationOptionEntry> AllCurrentConversationChoices;                     // 0x0060(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FClientConversationOptionEntry> UserCurrentConversationChoices;                    // 0x0070(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                         Pad_B0[0xA0];                                      // 0x00B0(0x00A0)(Fixing Size After Last Property [ Dumper-8 ])
...
public:
	...
	void RequestServerAdvanceConversation(const struct FConversationChoiceReference& InChoicePicked);
	void ServerAdvanceConversation(const struct FConversationChoiceReference& InChoicePicked);

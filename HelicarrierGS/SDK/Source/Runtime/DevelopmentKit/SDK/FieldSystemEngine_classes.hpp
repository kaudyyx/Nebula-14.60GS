...
public:
	...
	bool                                          IsChaosField;                                      // 0x0449(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_44A[0x26];                                     // 0x044A(0x0026)(Fixing Size After Last Property [ Dumper-8 ])
	TArray<TSoftObjectPtr<class AChaosSolverActor>> SupportedSolvers;                                // 0x0470(0x0010)(Edit, ZeroConstructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	float                                         Time;                                              // 0x00C8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EWaveFunctionType                             Function;                                          // 0x00CC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFieldFalloffType                             Falloff;                                           // 0x00CD(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_CE[0x2];                                       // 0x00CE(0x0002)(Fixing Struct Size After Last Property [ Dumper-8 ])

public:
	class UWaveScalar* SetWaveScalar(float Magnitude_0, const struct FVector& position_0, float Wavelength_0, float Period_0, float Time_0, EWaveFunctionType Function_0, EFieldFalloffType Falloff_0);

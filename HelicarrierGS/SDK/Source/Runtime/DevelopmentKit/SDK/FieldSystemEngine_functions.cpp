...
class UWaveScalar* UWaveScalar::SetWaveScalar(float Magnitude_0, const struct FVector& position_0, float Wavelength_0, float Period_0, float Time_0, EWaveFunctionType Function_0, EFieldFalloffType Falloff_0)
{
	static class UFunction* Func = nullptr;

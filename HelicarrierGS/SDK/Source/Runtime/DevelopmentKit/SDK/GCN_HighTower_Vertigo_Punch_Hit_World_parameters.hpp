...
struct GCN_HighTower_Vertigo_Punch_Hit_World_C_OnBurst final
{
public:
	...
	class UForceFeedbackComponent*                CallFunc_SpawnForceFeedbackAttached_ReturnValue;   // 0x0108(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

...
public:
	...
	float GetValueAtLevel(float Level) {
		return ((float (*)(FScalableFloat*, float, FString*)) (ImageBase + 0xA4B980))(this, Level, nullptr);//"FScalableFloat::GetValueAtLevel"
	}
	float GetValue() {
		return GetValueAtLevel(0);
	}

	float GetValueAtLevel67(float Level, const class FString* ContextString = nullptr) const
	{
		static float (*_GetValueAtLevel)(const FScalableFloat * Float, float Level, const class FString* ContextString) =
			decltype(_GetValueAtLevel)(InSDKUtils::GetImageBase() + 0xA4B980);

		return _GetValueAtLevel(this, Level, ContextString);
	}
};
...
public:
	...
	uint8                                         Pad_2CD[0x9B];                                     // 0x02CD(0x009B)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
public:
	...
	uint8                                         Pad_140[0x310];                                    // 0x0140(0x0310)(Fixing Size After Last Property [ Dumper-8 ])
...
public:
	...
	{
		// 7FF6977E0FA4
		struct FGameplayAbilitySpec* (*CreateDefaultAbilitySpec)(class FGameplayAbilitySpec* GameplayAbilitySpec, class UGameplayAbility* Ability, int32 Level, int32 InputID, class UObject* SourceObject) = decltype(CreateDefaultAbilitySpec)(0xa27b60 + uintptr_t(GetModuleHandle(0))); // SpecConstructor

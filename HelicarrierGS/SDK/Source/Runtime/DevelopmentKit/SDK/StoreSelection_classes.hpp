...
{
public:
	TSoftClassPtr<class UClass>                   StoreSelectionScreenClass;                         // 0x0380(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   RegularStoreSelectedText;                          // 0x03A8(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   NonRegularStoreSelectedText;                       // 0x03C0(0x0018)(Edit, NativeAccessSpecifierPublic)
